...
inputfile=myfile_helix.in

# Run mpi program
/usr/local/RH6_apps/openmpi-1.6.4-gnu/bin/mpirun -np 16 --mca orte_base_help_aggregate 0  -machinefile $MACHINEFILE /usr/local/RH6_apps/liggghts-15Feb2016/bin/liggghts < $inputfile > myfile_helix.out
